...
This project is indexed by GitNexus as **dashboard** (1107 symbols, 2649 relationships, 57 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
